...
const DividaTESScheme = mongoose.Schema({
  ...
  credor: {
    ...
    ref: "User",
    required: true
  }, // Conectar o devedor e o credor a um user.
  devedor: {
    type: mongoose.Schema.Types.ObjectID,
    ref: "User",
    required: true
  }, //ira sempre haver um user a dever neste scheme
  credorS: {
    type: String
  },
  devedorS: {
  ...
  quantia: {
    type: Number,
    required: true
  }, //preciso de ter a certeza que a quantia é um numero
  descricao: {
    type: String
  }, //pode ter ou nao uma descricao
  paga: {
    type: Boolean,
    default: false,
    required: true
  }, // estado se a divida está ativa ou inativa. Começa com o valor ativa se nada for introduzido
  userCriador: {
    type: mongoose.Schema.Types.ObjectID,
    ref: "User",
    required: true
  }, // user que cria a divida
  date: {
    type: String,
    required: true
  ...
  timesemailsent: {
    type: Number,
    required: true
  } //para conseguir ver em comparaçao com o tempo de criação o limite da divida mandada e quanto ja passou o tempo
